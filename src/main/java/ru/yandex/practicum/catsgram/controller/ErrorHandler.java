...
public class ErrorHandler {
    ...
    public ErrorResponse handleNullPointer(NotFoundException e) {
    ...
    public ErrorResponse handleConditionNotMet(ConditionsNotMetException e) {
        return new ErrorResponse(e.getMessage());
    }
    ...
    public ErrorResponse handleTrowable(Throwable e) {
